...
ActiveRecord::Schema.define(version: 2019_03_24_110958) do
  ...
  create_table "contentquestions", force: :cascade do |t|
    ...
    t.index ["paper_id"], name: "index_contentquestions_on_paper_id"
    t.index ["project_id"], name: "index_contentquestions_on_project_id"
    t.index ["user_id"], name: "index_contentquestions_on_user_id"
  end
  ...
  add_foreign_key "contentquestions", "papers"
  add_foreign_key "contentquestions", "projects"
  add_foreign_key "contentquestions", "users"
